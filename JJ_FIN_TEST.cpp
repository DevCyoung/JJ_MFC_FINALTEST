...
// JJ_FIN_TEST.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CJJFINTESTApp, CWinApp)

	ON_COMMAND(ID_APP_ABOUT, &CJJFINTESTApp::OnAppAbout)
...
CJJFINTESTApp::CJJFINTESTApp() noexcept
{

	// TODO: 아래 애플리케이션 ID 문자열을 고유 ID 문자열로 바꾸십시오(권장).
	// 문자열에 대한 서식: CompanyName.ProductName.SubProduct.VersionInformation
	SetAppID(_T("JJFINTEST.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CJJFINTESTApp 개체입니다.

CJJFINTESTApp theApp;


// CJJFINTESTApp 초기화

BOOL CJJFINTESTApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CJJFINTESTDoc),
		RUNTIME_CLASS(CMainFrame),       // 주 SDI 프레임 창입니다.
		RUNTIME_CLASS(CJJFINTESTView));
	if (!pDocTemplate)
		return FALSE;
